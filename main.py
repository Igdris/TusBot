...
async def show_all_movies(update: Update = None, context: ContextTypes.DEFAULT_TYPE = None, query=None, user_id=None):
...
async def main():
    ...
    try:
        ...
        if 'RENDER' in os.environ:
            ...
            # Запускаем с веб-хуком на Render
        ...
        print("3. Установите библиотеку: pip install python-telegram-bot==20.3")
...
if __name__ == '__main__':
    if TOKEN == '8032006876:AAE4b7z902XbYYQQ8VIW2J7kmIHTu8zVkO8':
        ...
        print("=" * 50)
        print("Для рабочего бота на Render:")
