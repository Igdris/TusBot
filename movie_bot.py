...
# ========== КОНФИГУРАЦИЯ ==========
# Используем переменную окружения на Render.com
TOKEN = os.environ.get('BOT_TOKEN')
if not TOKEN:
    print("❌ ОШИБКА: Переменная окружения BOT_TOKEN не установлена!")
    print("Пожалуйста, установите BOT_TOKEN на Render.com в разделе Environment")
    sys.exit(1)
...
def main():
    ...
    try:
        ...
        application.run_polling(
            ...
            drop_pending_updates=True  # Важно для перезапусков
        )
        ...
        print("\nРешение:")
        print("Убедитесь, что переменная окружения BOT_TOKEN установлена корректно")
        print("=" * 50)
